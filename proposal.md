...
Currently platform supports both 9.4 and 9.6 version of postgresql with different t-shirt sizes (plans). As per requirement, user has the flexibility to choose the plan. Plan provided will be like v9.4-small, v9.6-small, v9.6-large etc. Each plan is unique combination of disk, cpu, memory etc. 
